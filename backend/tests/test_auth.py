...
class TestAuthBasicOperations:
    """Базовые тесты операций аутентификации."""
...
class TestAuthNegativeCases:
    """Параметризованные тесты негативных сценариев аутентификации."""
    ...
    def test_create_token_negative_cases(self, auth_client, username, password, test_name):
...
@pytest.mark.backend
@allure.feature("Аутентификация")
@allure.story("Безопасность: тесты на уязвимости")
class TestAuthSecurity:
    ...
    def test_auth_sql_injection_attempt(self, auth_client, username, password, injection_type):
